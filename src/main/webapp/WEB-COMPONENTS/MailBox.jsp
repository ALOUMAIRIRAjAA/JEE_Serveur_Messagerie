                        ...
                        <div class="col-lg-3 col-md-4">
                            ...
                            <div class="card shadow-none mt-3">
                                <div class="list-group shadow-none">
                                    <button id="inbox_mail_btn" class="list-group-item active"><i class="fa fa-inbox mr-2"></i>boite de reception  <b>(<%=emails.size()%>)</b></button>
                                    <button id="send_mail_btn" class="list-group-item"><i class="fa fa-paper-plane-o mr-2"></i>messages envoyés <b>(<%=sendMails.size()%>)</b> </button>
                                    <button id="trash_mail_btn" class="list-group-item"><i class="fa fa-star" aria-hidden="true"></i>   messages suivis  <b>()</b></button>
                                    <button id="send_mail_btn" class="list-group-item"><i class="fa fa-clock-o" aria-hidden="true"></i>   En attente   <b>(<%=sendMails.size()%>)</b> </button>
                                     <button id="trash_mail_btn" class="list-group-item"><i class="fa fa-trash-o mr-2"></i>Corbille <b>()</b></button>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="btn-toolbar" role="toolbar">
                                        <div class="btn-group mr-1">
                                            ...
                                            <button type="button" class="btn btn-outline-primary waves-effect waves-light"><i class="fa fa-star" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
